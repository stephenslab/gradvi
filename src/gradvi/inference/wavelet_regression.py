...
class WaveletRegression(GradVIBase):
    ...
    def fit(self, y, prior, W, x_init = None, s2_init = None):
        """
        Fit Wavelet model.
        ...
        self._dj        = np.sum(np.square(self._W), axis = 0)
    ...
    def initialize_params(self, b_init, s2_init):
        """
        ...
        coef_init  = np.zeros(n) if b_init is None else b_init
